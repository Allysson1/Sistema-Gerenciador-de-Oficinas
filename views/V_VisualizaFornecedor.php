        ...
        <div class="main-content">
            ...
            <div class="row">            
                    <div class="col-12 divHeaderTopoSite">
                        <p class="nameHeaderTopoSite">Visualizar Fornecedores</p>
                    </div>  
                </div> 
            ...
            <main class="p-md-1 p-lg-5"> 
                ...
                <div class="row" style="margin: 0px">
                    <div class="containerPesquisaHome ml-auto">
                        <div class="col-12">
                            <input type="text" class="inputPesquisaHome" id="filtrar-tabela" placeholder="Digite o fornecedor...">
                        </div>
                    </div>                
                </div>  

                
                <div class="TabelaFornecedor">
                    <table class="table table-bordered ml-3 ml-md-3 ml-lg-3 mt-lg-5 col-12 col-lg-12">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM fornecedor WHERE status ='' ";
                                ...
                                if (mysqli_num_rows($query_run) > 0){
                                    ...
                                    foreach($query_run as $fornecedor){
                                        ...
                                        <tr class="consulta">
                                            ...
                                            <td class="info-nome"><?= $fornecedor['nome do fornecedor'];?></td>
                                            <td><?= $fornecedor['cnpj do fornecedor'];?></td>
                                            <td><?= $fornecedor['contato do fornecedor'];?></td>
                                            <td><?= $fornecedor['endereço do fornecedor'];?></td>
                                            <td><?= $fornecedor['cidade'];?></td>
                                            <td><?= $fornecedor['estado'];?></td>
                                            <td>
                                                <form action="../models/Code_Fornecedor.php" method="POST" class="d-inline">

                                                    <a data-toggle="modal" data-target="#ModalUsuario<?= $fornecedor['idFornecedor'];?>"
                                                    class="m-1 btn btn-sm btn_visualizar">Visualizar</a>
                                                    
                                                    <button type="submit" name="delete_fornecedor" 
