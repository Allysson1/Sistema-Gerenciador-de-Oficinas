...
<body>
    ...
    <main class="main-content">   
        ...
        <section class="section-content">
            <form action="../models/Code_Peca.php" method="POST" class="ml-3 ml-md-3 ml-lg-3 col-12 col-lg-12">
                <div class="row">
                    <div class="col-12" style="display: flex; margin-bottom: 30px; margin-top: 45px">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="NomePeca" class="form-control campoDigitarCadasServico">
                        </div>                                        
                    </div>
                    ...
                    <div class="col-12" style="display: flex; margin-bottom: 30px;">
                        <div class="col-6">
                            ...
                            <input type="text" name="MarcaPeca" class="form-control campoDigitarCadasServico">
                        </div>
                        <div class="col-6">
                    ...
                    <div class="col-12" style="display: flex; margin-bottom: 30px;">
                        <div class="col-6">
                            ...
                            <input type="text" name="CnpjForncedor" class="form-control campoDigitarCadasServico">
                        </div>
                        <div class="col-6">
                            <label for="nomefornecedor">Nome do Fornecedor:</label>
                            <input type="text" name="NomeFornecedor" class="form-control campoDigitarCadasServico">
                        </div>                   
                    </div>
                    ...
                    <div class="col-12" style="display: flex; margin-bottom: 30px;">
                        <div class="col-6">
                            ...
                            <input type="tel" name="TelFonecedor" class="form-control campoDigitarCadasServico" required placeholder="(xx) xxxxx-xxxx">
                        </div>
                        <div class="col-6">
                            <label for="datapedido">Data de Pedido:</label>
                            <input type="date" name="DataPedido" class="form-control campoDigitarCadasServico">
                        </div>                   
                    </div>
                    ...
                    <div class="col-12" style="display: flex; margin-bottom: 30px;">
                        <div class="col-6">
                            ...
                            <input type="date" name="DataRecebimento" class="form-control campoDigitarCadasServico">
                        </div>
                        <div class="col-6">
