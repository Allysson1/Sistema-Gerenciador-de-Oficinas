...
if (isset($_POST['save_fornecedor'])){
    ...
    $contatofornecedor = mysqli_real_escape_string($con, $_POST['contatofornecedor']);
    $enderecofornecedor = mysqli_real_escape_string($con, $_POST['endereçofornecedor']);
